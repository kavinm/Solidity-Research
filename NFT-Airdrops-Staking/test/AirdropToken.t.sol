...
contract AirDropTokenTest is Test {
    ...
    function setUp() public {
        ...
        adToken = new AirDropToken(merkleRoot);
    }
    ...
    function testClaimAirDrop() public {
        ...
        assertEq(adToken.balanceOf(alice), 0);

        vm.prank(alice);
        adToken.claimAirDrop(proof, index, amount);

        assertEq(adToken.balanceOf(alice), 10000000000000000000);
    }
}
